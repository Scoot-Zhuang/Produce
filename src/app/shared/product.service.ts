...
export class ProductService {
  ...
  private comments: Comment[] = [
    new Comment(1, 1, '2018-1-14', '海涛', 3.5, '不错哦'),
    new Comment(1, 1, '2018-1-14', '毛首元', 4.5, '不错哦'),
    new Comment(2, 1, '2018-1-14', '王龙', 3.5, '不错哦'),
    new Comment(3, 1, '2018-1-14', '张慎慎', 2.5, '不错哦'),
    new Comment(4, 2, '2018-1-14', '史召', 3.5, '不错哦'),
    new Comment(5, 2, '2018-1-14', '张颖', 4.5, '不错哦'),
    new Comment(6, 3, '2018-1-14', '盼盼', 3.5, '不错哦'),
  ];
